...
function pesq() {
  ...
  var text = document.getElementById("most-tudo")
  if(l)
  {
    text.innerHTML = "<p>Local: "+ l.nome_loc +"</p><p>Cidade: "+ l.cidade +"</p><p>Rua: "+ l.rua +"</p><p>Bairro: "+ l.bairro +"</p><p>Número: "+ l.num +"</p><p>Comentario: "+ l.comit+"</p>";
...
function limpar(){
  ...
  document.getElementById('most-tudo').value = "";

  /*document.getElementById('nome_loc_busq').value = "";
  document.getElementById('cidade_busq').value = "";
  document.getElementById('rua_busq').value = "";
  document.getElementById('bairro_busq').value = "";
  document.getElementById('num_busq').value = "";
  document.getElementById('comit_busq').value = "";*/
}